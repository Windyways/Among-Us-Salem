...
public static class TouCrewAssets
{
    ...
    private const string DAG = $"{ShortPath}.Sprites.Abilities";
    ...
    public static LoadableAsset<Sprite> Inquisitor_Investigate { get; } = new LoadableResourceAsset($"{DAG}.Inquisitor_Investigate.png");
    public static LoadableAsset<Sprite> Medium_Mediate { get; } = new LoadableResourceAsset($"{DAG}.Medium_Mediate.png");
    public static LoadableAsset<Sprite> Stalker_Track { get; } = new LoadableResourceAsset($"{DAG}.Stalker_Track.png");

    public static LoadableAsset<Sprite> AttackSprite { get; } = new LoadableResourceAsset($"{DAG}.Attack.png");
