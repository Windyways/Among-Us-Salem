...
public static class TouRoleIcons
{
    ...
    public static LoadableAsset<Sprite> PlaceholderRC { get; } = new LoadableResourceAsset($"{iconPath}.Aurial.png");
    ...
    public static LoadableAsset<Sprite> Assassin { get; } = new LoadableResourceAsset($"{iconPath}.Assassin.png");
