...
public sealed class DoomsayerObserveButton : ObjectWorkshopRoleButton<DoomsayerRole, PlayerControl>
{
    public override string Name => "Observe";
    public override string Keybind => Keybinds.SecondaryAction;
    public override Color TextOutlineColor => OWColors.Doomsayer;
    ...
    protected override void OnClick()
    {
        ...
        var notif1 = Helpers.CreateAndShowNotification(
            $"<b>{OWColors.Doomsayer.ToTextColor()}You will recieve a report on {Target.Data.PlayerName} during the next meeting. This will help you narrow down their role.</color></b>",
